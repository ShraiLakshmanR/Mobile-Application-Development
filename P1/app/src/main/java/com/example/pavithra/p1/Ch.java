...
public class Ch extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_ch, container, false);

        cp=(EditText)v.findViewById(R.id.e8) ;
        ...
        sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!value1.contentEquals(value2)) {
                    ...
                    Cursor c = db.rawQuery("SELECT * FROM parent1_table WHERE NAME='" + name1 + "' and PASSWORD='" + pass1 + "'", null);
                    if (c.moveToFirst()) {
                        db.execSQL("UPDATE parent1_table SET password='" + rp.getText() + "' WHERE NAME='"+name1+"'" );

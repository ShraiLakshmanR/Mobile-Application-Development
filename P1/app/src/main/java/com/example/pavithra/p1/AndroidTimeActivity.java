 ...
 EditText et,et2;
    ...
    = new OnTimeSetListener(){
    	...
    	public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
    		...
    		Toast.makeText(getApplicationContext(), "Alarm set time is "+hourOfDay+" "+minute, Toast.LENGTH_SHORT).show();
    		Toast.makeText(getApplicationContext(), "Current time is "+hour+" "+min, Toast.LENGTH_SHORT).show();

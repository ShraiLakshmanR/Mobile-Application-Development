...
public class FragementOne extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_fragement_one, container, false);
        Bundle bundle = this.getArguments();
        name1 = bundle.getString("N1");
        pass1 = bundle.getString("P1");


        ListView list2 = (ListView)v.findViewById(R.id.list11);


        lines = new ArrayList<String>();
        Database dat = new Database(getContext());
        SQLiteDatabase db = dat.getReadableDatabase();
        Cursor c1 = db.rawQuery("select * from parent1_table where name='"+ name1 +"' and password='"+ pass1 +"';", null);
